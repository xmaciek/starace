...
void SpinBox::render( const RenderContext& r ) const
{
    ...
    pushConstant.m_sprites[ 0 ].m_sampleRGBA = textureIs4Channel( m_arrowLeft.texture );
    ...
    pushConstant.m_sprites[ 1 ].m_sampleRGBA = textureIs4Channel( m_arrowRight.texture );
