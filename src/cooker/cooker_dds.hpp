...
inline uint8_t slerp( uint16_t e0, uint16_t e1 )
{
...
inline BC4 compressor_bc4( std::span<const uint8_t, 16> block )
{
    ...
    const std::array<uint8_t, 8> arr1{
        ...
        slerp<9>( ret.alpha0, ret.alpha1 ),
        slerp<18>( ret.alpha0, ret.alpha1 ),
        slerp<27>( ret.alpha0, ret.alpha1 ),
        slerp<37>( ret.alpha0, ret.alpha1 ),
        slerp<46>( ret.alpha0, ret.alpha1 ),
        slerp<55>( ret.alpha0, ret.alpha1 ),
    };
