...
void Font::make_dlist (TTF_Font *font, GLuint ch) {
  ...
  glNewList(list_base+ch, GL_COMPILE);
    ...
    glPushMatrix();
      glBegin(GL_QUADS);
        glTexCoord2d(0, 0); glVertex2d(0, optH);
        glTexCoord2d(0, 1); glVertex2d(0, 0);
        glTexCoord2d(1, 1); glVertex2d(optW, 0);
        glTexCoord2d(1, 0); glVertex2d(optW, optH);
      glEnd();
    glPopMatrix();
...
GLuint Font::GetHeight() { return height; }
GLuint Font::GetMiddlePoint() { return middlepoint; }